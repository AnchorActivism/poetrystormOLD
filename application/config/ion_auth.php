...
$config['tables']['sm_user_profiles']= 'sm_user_profiles';
 ...
 */
$config['site_title']           = "PeoplesMic.net"; 		// Site Title, example.com
$config['admin_email']          = "patrick.turmala@gmail.com"; 	// Admin Email, admin@example.com
